...
# Check Part 1 completed
if [ ! -d "outputs/phase3/zero_shot" ]; then
    echo "ERROR: Zero-shot results not found. Run Part 1 first!"
    exit 1
fi
...
echo "  outputs/phase3/paper_figures/monolingual_experiments.png + .csv"
echo "  outputs/phase3/paper_figures/multilingual_experiments.png + .csv"
echo "  outputs/phase3/paper_figures/adaptation_experiments.png + .csv"
echo "  outputs/phase3/paper_figures/statistical_winner.csv"
echo "  outputs/phase3/paper_figures/winner_declaration.txt"
